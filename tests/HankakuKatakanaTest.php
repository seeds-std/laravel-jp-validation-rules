...
use SeedsStd\JpValidationRules\HankakuKatakana;
...
class HankakuKatakanaTest extends TestCase
{
    ...
    {
        return Validator::make(['name' => $string], ['name' => new HankakuKatakana($params)]);
    }
    ...
    {
        $this->assertTrue($this->validator('ﾔﾏﾀﾞﾀﾛｳ')->passes());
    }
}